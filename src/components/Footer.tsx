    ...
    <footer className="bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 py-16">
        ...
        >
          ...
          <h2 className="text-2xl font-bold tracking-wide mb-2">Bekdoosan</h2>
          ...
          <p className="text-gray-300 max-w-md text-sm leading-relaxed mb-6">
            ...
            <span className="text-electric-purple">artes marciales</span> en Segovia.
          ...
          <div className="flex justify-center space-x-4">
            {[Instagram, Facebook, Globe].map((Icon, idx) => (
              <motion.a
                key={idx}
                href="#"
                className="relative p-3 rounded-full bg-electric-blue/20 hover:bg-electric-blue/30 transition-all duration-300"
                whileHover={{ scale: 1.15 }}
              >
                <Icon className="h-5 w-5 text-electric-blue" />
                <span className="absolute inset-0 rounded-full border border-electric-blue/40 animate-ping-slow" />
              </motion.a>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4 text-sm text-gray-300">
            <div className="flex justify-center items-start space-x-2">
              ...
              <p>C/ Antonio Coronel 16<br />40003 Segovia</p>
            </div>
        ...
        >
          ...
          >
            ...
            <a
              ...
              className="text-electric-blue hover:text-electric-green transition-colors font-semibold"
            >
              Sergio Esteban
            </a>{" "}
            ·{" "}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-electric-purple hover:text-electric-green transition-colors font-semibold"
            >
              Diseño Web Studio
            </a>
          </motion.p>
